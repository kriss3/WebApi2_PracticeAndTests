...
using WebAppSimpleApi.Models;

namespace WebAppSimpleApi.Controllers
{
    public class EmployeeController : ApiController
    {
		IList<Employee> employees = new List<Employee>()
		{
			...
			new Employee()  {   EmployeeId = 6, EmployeeName = "Elon Musk", Address = "California", Department = "Management"},
		};
